...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/friends/create" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Teman</a>
</div>
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="/friends/{{ $friend['id'] }}" class="m-0 font-weight-bold text-primary h6">{{ $friend['nama'] }}</a>
                </div>
                <div class="card-body">
