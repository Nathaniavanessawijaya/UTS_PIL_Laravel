...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/groups/create" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Group</a>
</div>
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="/groups/{{$group['id']}}" class="m-0 font-weight-bold text-primary h6">{{ $group['name'] }}</a>
                    <p class="card-text">{{ $group['description'] }}</p>
                    <a href="/groups/addmember/{{$group['id']}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Anggota</a>
                </div>
                <div class="card-body">
